...
public class Writer_ManipulateAfterClose {

    public void writer_ManipulateAfterCloseEvent(String[] history) {

        String[] interesting = new String[] {"write", "flush"};
        if (filter(history, interesting)) {
            LoggerSpecification.printLogging(SpecificationType.Writer_ManipulateAfterClose);
        }
