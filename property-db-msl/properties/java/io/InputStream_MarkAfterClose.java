...
public class InputStream_MarkAfterClose {
  
	  public void InputStream_ManipulateAfterCloseEvent(String[] history) {

	        String[] interesting = new String[] {"mark"};
	        if (filter(history, interesting)) {
	            LoggerSpecification.printLogging(SpecificationType.InputStream_MarkfterClose);
	        }
