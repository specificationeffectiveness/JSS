...
public class Console_CloseReader {

	public void eventConsole_CloseReader(String[] history) {

		String[] interesting = new String[] {"close"};
		if(filter(history,interesting)) {
			LoggerSpecification.printLogging(SpecificationType.Console_CloseReader); 
		}
	}
